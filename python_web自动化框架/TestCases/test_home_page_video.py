...
class Test_Home_Page_video:
    ...
    def test_click_original_selected_title(self,login_web):
    ...
    @pytest.mark.gg
    @pytest.mark.usefixtures('login_web')
    def test_click_original_selected_left_arrow(self,login_web):
        home=HomePage(login_web)
    ...
    #3.点击首页的视频分类的音乐分类，点击第一个视频的视频 封面 查看视频(会新增页面)  验证视频时长、视频标题、作者，视频封面是一样的
